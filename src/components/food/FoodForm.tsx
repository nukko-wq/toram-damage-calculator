...
export default function FoodForm({ food: _food, onFoodChange }: FoodFormProps) {
	...
	return (
		<div className="rounded-lg shadow-md bg-white p-4 md:col-start-1 md:col-end-5 md:row-start-4 md:row-end-5 xl:col-start-1 xl:col-end-2 xl:row-start-5 xl:row-end-6">
