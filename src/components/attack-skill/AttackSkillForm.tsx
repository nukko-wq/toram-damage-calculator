...
export default function AttackSkillForm({
	...
	return (
		<div className="space-y-4 p-4 shadow-md rounded-lg bg-white md:col-start-3 md:col-end-9 md:row-start-6 md:row-end-8 xl:col-start-3 xl:col-end-4 xl:row-start-6 xl:row-end-8 max-w-full overflow-hidden">
