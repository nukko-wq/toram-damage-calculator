...
export default function CrystalCard({ crystal, isSelected, onClick }: CrystalCardProps) {
	...
	return (
		...
		>
			...
			{/* タイプバッジ */}
			<div className="mb-2">
				<span className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${getTypeColor(crystal.type)}`}>
